...
from app.models import Model, UserORM
...
async def main():
    ...
    bob = UserORM(name="Bob", age=42, passport="001")
    sam = UserORM(name="Sam", age=25, passport="002")
    ...
    await users_repository.update(2, UserORM(name="Alice", age=18, passport="003"))
